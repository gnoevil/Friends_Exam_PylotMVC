...
routes['/greetings'] = 'Friends#greetings'
routes['POST']['/login'] = 'Friends#login'
routes['/logout'] = 'Friends#logout'
routes['/view_profile/<id>'] = 'Friends#view_profile'
routes['/delete/<id>'] = 'Friends#delete'
routes['/add_friend/<id>'] = 'Friends#add_friend'
routes['/view_alias/<id>'] = 'Friends#view_alias' 
"""
